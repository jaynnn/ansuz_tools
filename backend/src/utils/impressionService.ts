...
2. 字数400-500字左右，充分展现这个人的特点，确保内容丰富有深度。
3. 语气自然客观，基于事实描述，不要刻意夸张或美化。
4. 应充分融入个人信息中的具体细节，如兴趣爱好（游戏、追剧、音乐、运动等）、生活习惯（作息、饮食、社交风格等）、学历职业等，这些信息比抽象的性格描述更能让读者了解这个人的真实面貌。对用户填写的每一项信息都应有所体现，不要遗漏。
...
生成配对理由时的【重要要求】：
- 不要求每对都必须写出正面的配对理由。如果两人完全不契合或契合度很低（总分低于60），配对理由应如实说明不契合或冲突的地方（如"你们的作息习惯差异较大，一方早睡一方熬夜"、"社交风格截然不同，可能难以磨合"），而不是硬凑正面理由。
- 如果契合度较高，配对理由应具体说明契合点；如果契合度低，配对理由应直接指出主要的冲突或不匹配之处，让用户了解真实情况。
${hasBothPersonalInfo ? '- 双方均有个人信息，配对理由中【必须】具体提及双方在兴趣爱好、生活习惯、社交风格等方面的契合点或冲突点（如契合："你们都喜欢玩原神，可以一起组队"；如冲突："你偏好早睡，对方习惯熬夜，生活节奏差异明显"）。不能只说笼统的评价。' : hasAnyPersonalInfo ? '- 仅有一方提供了个人信息，配对理由中可适度提及该方的兴趣爱好特点，但不要凭空给未填写信息的一方编造兴趣或生活习惯。' : '- 双方均未提供个人信息，配对理由中不要编造任何关于兴趣爱好、生活习惯的描述，应聚焦于性格和心理层面的匹配。'}
...
- 不要无中生有或刻意拔高对方的条件。对于对方的不足之处，不需要刻意隐藏，该说明冲突的地方应直说。
严格输出纯JSON格式，示例：
